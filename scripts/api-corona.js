  ...
  .then((response) => {
    ...
    const coronaUSA = `<div>
            ...
            <tr>
                ...
                <td class="tg-0lax">${response.data.cases}</td>
            </tr>
            <tr>
                <td class="tg-0lax">Cases (today) :</td>
                <td class="tg-0lax">${response.data.todayCases}</td>
            </tr>
            <tr>
                <td class="tg-0lax">Deaths :</td>
                <td class="tg-0lax">${response.data.deaths}</td>
            </tr>
            <tr>
                <td class="tg-0lax">Deaths (today) :</td>
                <td class="tg-0lax">${response.data.todayDeaths}</td>
            </tr>
            <tr>
                <td class="tg-0lax">Recovered :</td>
                <td class="tg-0lax">${response.data.recovered}</td>
            </tr>
            <tr>
                <td class="tg-0lax">Total Tested :</td>
                <td class="tg-0lax">${response.data.tests}</td>
            </tr>
            </tbody>
            </table>
        </div>`;
